...
## Default Parameters
```yaml
base_local_planner: vector_pursuit_controller/VectorPursuitController
...
## Quickstart Tutorial
1. Create a ROS workspace and clone the repository into this workspace.
	```bash
	mkdir -p ~/catkin_ws/src && cd ~/catkin_ws/src
    
	git clone https://github.com/txphuc2799/vector_pure_pursuit.git
...
2. Build the workspace and source it.
	```bash
	cd ~/catkin_ws && catkin_make ---pkg vector_pure_pursuit
	```
